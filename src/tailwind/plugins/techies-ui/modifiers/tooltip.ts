export const tooltip = {
    ...
    '.tooltip, .tooltip-top': {
        '&:after': {
          ...
          ':is(.dark) &': {
                'border-color': 'var(--tooltip-color-dark) transparent transparent transparent',
            }
        }
    },
    ...
    '.tooltip-bottom': {
        '&:after': {
          ...
          ':is(.dark) &': {
            'border-color': 'transparent transparent var(--tooltip-color-dark) transparent',
            }
        }
    },
    ...
    '.tooltip-left': {
        '&:after': {
          ...
          ':is(.dark) &': {
            'border-color': 'transparent transparent transparent var(--tooltip-color-dark)',
            }
        }
    },
    ...
    '.tooltip-right': {
        '&:after': {
          ...
          ':is(.dark) &': {
            'border-color': 'transparent var(--tooltip-color-dark) transparent transparent',
            }
        }
    },
