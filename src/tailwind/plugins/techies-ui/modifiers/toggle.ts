...
export const toggle = {
    ...
    '.toggle': {
        ...
        ':is(.dark) &': {
            ...
            'box-shadow': 'var(--handleoffsetcalculator) 0 0 2px var(--tglbg-dark) inset, 0 0 0 2px var(--tglbg-dark) inset, var(--togglehandleborder)',
        },
        ...
        '&:indeterminate': {
            ...
            ':is(.dark) &': {
                '@apply border-base-content-dark bg-base-content-dark': {},
                'box-shadow': 'calc(var(--handleoffset) / 2) 0 0 2px var(--tglbg-dark) inset, calc(var(--handleoffset) / -2) 0 0 2px var(--tglbg-dark) inset, 0 0 0 2px var(--tglbg-dark) inset',
            },
        ...
        '&:disabled': {
            ...
            ':is(.dark) &': {
                ...
                '--togglehandleborder': '0 0 0 3px hsl(var(--bc-d)) inset, var(--handleoffsetcalculator) 0 0 3px hsl(var(--bc-d)) inset',
            },
        }
    },
