...
export const range = {
    ...
    '.range': {
        ...
        '&:focus-visible::-webkit-slider-thumb': {
          ...
          ':is(.dark) &': {
                '--focus-shadow': '0 0 0 6px hsl(var(--b1-d)) inset, 0 0 0 2rem hsl(var(--range-shdw-dark)) inset',
            }
        },
        ...
        '&::-webkit-slider-thumb': {
            ...
            ':is(.dark) &': {
                ...
                'box-shadow': '0 0 0 3px hsl(var(--range-shdw-dark)) inset, var(--focus-shadow, 0 0), calc(var(--filler-size) * -1 - var(--filler-offset)) 0 0 var(--filler-size)',
            }
        },
